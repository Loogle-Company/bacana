...
// efeito do texto
  ...
  window.addEventListener('scroll', function() {
    ...
    if (scrollY > 3000) { // Defina o valor em pixels em que deseja que o elemento desapareça.
      container.classList.add('hidden'); // Adiciona a classe 'hidden' para ocultar o elemento.
    } else {
      container.classList.remove('hidden'); // Remove a classe 'hidden' para mostrar o elemento.
    }
  });